      ...
      <ol className="flex items-center justify-center gap-2 text-[13px]">
        {STEPS.map((s, i) => (
          <li
            ...
            style={
              i === step
                ? { background: "rgba(143,176,232,.12)", border: "1px solid rgba(143,176,232,.45)" }
        ...
        <div className="rounded-panel bg-hull grid gap-4 border p-[26px]" style={{ borderRadius: 20 }}>
          ...
          <Field label="Dev-buy (optional) — your own first buy">
            <div
              ...
              style={{ borderColor: overCap || badDevBuy ? "#de8092" : "rgba(148,168,196,0.2)" }}
            >
              <input
                value={devBuy}
          ...
          <Field label="Coin art">
            <div
              ...
              style={{ borderColor: dragging ? "#8fb0e8" : "rgba(148,168,196,0.2)", background: dragging ? "rgba(143,176,232,.06)" : "transparent" }}
            >
        ...
        <div className="flex flex-col gap-4">
          <div className="rounded-panel bg-hull flex flex-col items-center gap-2 border p-6 text-center" style={{ borderRadius: 20 }}>
            {upload.previewUrl ? (
              ...
              <CoinAvatar image={upload.imageUri} emoji={emoji} ticker={tickerUp} size={80} className="rounded-2xl" style={{ border: "1px solid rgba(148,168,196,0.2)" }} />
            ) : (
...
function Row({ k, v, mono }: { k: string; v: string; mono?: boolean }) {
  return (
    <div className="flex justify-between py-1.5 text-sm" style={{ borderBottom: "1px solid rgba(148,168,196,0.14)" }}>
