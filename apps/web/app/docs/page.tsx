...
export const metadata: Metadata = {
  ...
  description: "Everything about the harbor — launches, trading, graduation, fees, network facts, and contracts.",
}
...
const sections: Section[] = [
  {
    ...
    body: (
      <>
        <Para>
          berth.club is a place to launch and trade fixed-supply tokens on Arc. Browse the harbor, open any ship for its
        ...
        <Bullets
          items={[
            ...
            "Prices come from each ship’s live USDC pool.",
  ...
  },
  {
    ...
    body: (
      <>
        <Para>
          Creating a ship deploys the token and its trading pool in one transaction: the full 100B supply is minted, a
        ...
        <StepCells
          steps={[
            ...
            {
              title: "Graduate",
              body: "At 8,787 USDC bought through the range, the ship graduates and keeps trading in the same pool.",
            },
          ]}
        />
        <Para>
      ...
      <>
        ...
        <DefGrid
          items={[
            ...
            { term: "Fee", def: "1% of every fill, split with the ship’s creator." },
          ]}
        />
      </>
    ),
  },
  {
    ...
    body: (
      <Para>
        A ship graduates when 8,787 USDC has been bought through its range. The sail on each progress bar tracks how
    ...
    body: (
      <KV
        rows={[
          ...
          ["Pool fee", `${SYSTEM.uniswap.feeTier} (1%)`],
          ["Launch fee", "1 USDC"],
      ...
      <>
        ...
        <AddressRows
          rows={[
            ...
            { label: "LP locker", addr: CONTRACTS.lpLocker },
            { label: "Fee locker", addr: CONTRACTS.feeLocker },
            { label: "Swap router", addr: SYSTEM.uniswap.swapRouter },
            { label: "USDC (quote token)", addr: SYSTEM.usdc },
          ]}
        />
      </>
    ),
    ...
    body: (
      <FAQ
        items={[
          ...
          {
            q: "What happens after a ship graduates?",
...
export default function DocsPage() {
  return (
    <LegalLayout
      ...
      title="Everything about the harbor, in one place."
      maxWidth={1120}
      numberedNav={false}
      headerAside={
        <div
